 ...
 *
 * @see [fs.readdirSync]
 * @param {string} modulesDir  - The directory to search. Default is [MODULES_PATH].
 * @return {Promise<string[]>} - The list with the absolute path of all the possible modules.
 */
 ...
 *
 * @param {string} moduleDir - The directory to search for the module data.
 * @return {ModulePackageInfo} - The module data.
 ...
 *
 * @see [readModuleInfo]
 * @param {string} moduleDir - The directory to search for the information.
 * @return {Promise<ModulePackageInfo>} - The object with the package information.
 ...
 * @param {string} modulesDir - The directory to search for the modules. Default to [MODULES_PATH].
 * @return {Promise<[ModulePackageInfo]>} - Information about all the valid discovered packages.
 */
